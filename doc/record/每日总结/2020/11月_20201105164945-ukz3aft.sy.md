...
#### 总结
{: id="20201109183324-0h7148v"}

这个~~项目~~ 方法 的重点在于复用了服务端提供接口的类型，并且可以直接跳转过去。
{: id="20201109183316-bna1vo9"}

追求简单的方法，完善类型体验。
{: id="20201109183359-8xq42rr"}

我写出这个想法之后觉得我以前就是憨憨，自己写一个项目还维护一份接口文档 😀。
{: id="20201109183509-rhswuc9"}

---

现在 codesandbox 还不支持中文文件名，坑了我一把
{: id="20201109170949-rlifwv8"}

![image.png](assets/20201109171018-un3fain-image.png)
{: id="20201109171005-dff4cnz"}

## 2020-11-13
{: id="20201113135459-1yky2kh"}
...
```
{: id="20201113135603-7xdvjuf"}

{: id="20201113135603-vnh7ceg"}
