...
{: id="20201117100246-gk4tuly"}

例如本文正确地址 https://shenzilong.cn/record/每日总结/2020/11月.html ，如果用户输入错了写成了 https://shenzilong.cn/record/每日总结2020/11月.html （每日总结后面少了个 「/」）
{: id="20201117100345-hzld28k"}

![image.png](assets/20201117100730-7in4b2o-image.png) 
{: id="20201117100729-ob5qdu5"}

咱依旧能如图中这般推荐给用户他可能想要访问的地址 😀
{: id="20201117100637-caeuov4"}

### 编辑距离算法
{: id="20201117100903-ru0929e"}
...
```
{: id="20201117101004-8nxcvgd"}

作为调包侠的我只要知道 `minDistance` 可以只传入两数组，他就返回一个数值表示这两数组之间的差异，数值越大差异越大就可以了
{: id="20201117100807-z3rk6hs"}

然后就是获取全站链接与用户输入地址一一比较返回差异最小的五个给用户查看
{: id="20201117101430-aq1cr8m"}

---

{: id="20201117144207-ufxh3h3"}
...
{: id="20201117144236-srrezaf"}

{: id="20201117101548-2ndyjmg"}

{: id="20201117101508-xef7x2g"}

{: id="20201117101411-dksuf0d"}
