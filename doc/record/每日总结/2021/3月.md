...
- {: id="20210403200326-300ya2r"}#疑问# [js 一个函数执行的时候如何判断自己是否处于另一个的调用栈中？ - 知乎 (zhihu.com)](https://www.zhihu.com/question/452024776)
  ...
  - {: id="20210330134956-toixz4q"}((20210403195639-rtqtffm "{{.text}}"))
    {: id="20210403200326-fbuhssh" updated="20210403200345"}
  {: id="20210403200526-avbc3jv"}
{: id="20210330075652-0mqj3fy" updated="20210403200331"}

- {: id="20210428222230-cwc9as4"}svelte-kit 中测试用例的运行方法：
  {: id="20210428222230-2zbxnst" updated="20210428222241"}

  1. {: id="20210428222242-u175xrm"}拉取代码
     {: id="20210428222242-346maj5" updated="20210428222249"}
  1. {: id="20210428222249-dtp8v9n"}run `npm i`
     {: id="20210428222249-k87412m" updated="20210428222733"}
  1. {: id="20210428222253-ysex3n9"}run `pnpm build`
     {: id="20210428222253-z6cyndk" updated="20210428222736"}
  1. {: id="20210428222256-p9tsdbe"}在自己的测试用例中像这样[添加test.only](https://github.com/sveltejs/kit/commit/0d581cbe9db7312183a713f0495a10867c8dfe8b)
     {: id="20210428222256-53pueh5" updated="20210428222422"}

     - {: id="20210428222402-8uteqk5"}记得提交的时候去掉 `.only`
       {: id="20210428222402-lleb77k" updated="20210428222414"}
     - {: id="20210428222429-wk3bwo5"}另外 discord 是个好东西，我想在 svelte-kit 添加测试用例的时候发现无从下手。主页有一句
       {: id="20210428222530-m7ng7mv"}

       > To run a single test, open up the file and change `test` to `test.only` for the relevant test.
       > {: id="20210428222530-8wjukgc"}
       >
       {: id="20210428222429-exrdzf7" updated="20210428222530"}

       但我不明白具体该怎么做，又不好意思去问，结果在 svelte 的 discord 中搜索聊天记录发现了正确做法。
       {: id="20210428222539-6j5p6aj" updated="20210428222800"}

       - {: id="20210428222639-0e939lq"}不知道国内的聊天工具什么时候才能支持这样的搜索
         {: id="20210428222639-hyrpnnl" updated="20210428222702"}
       {: id="20210428222642-hx8fgck"}
     {: id="20210428222402-bsz5mox"}
  1. {: id="20210428222708-we1wxfu"}run `pnpm test`
     {: id="20210428222706-05ludwn" updated="20210428222727"}
  {: id="20210428222242-og446fo"}
{: id="20210403200548-6ofy54l" updated="20210428222230"}

{: id="20210428223042-d0cer25"}
