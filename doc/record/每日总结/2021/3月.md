...
- {: id="20210303212529-zzkrn44"}[Index | Hegel](https://hegel.js.org/) 一个有意思的基于 js 的静态类型语言，比 ts 要克制和稳健严格许多
  ...
  - {: id="20210303213928-8x0msjx"}
    ...
    function f(p: Array<A>) {
        p[0] = new A() // 这样的操作在 p 为 Array<B> 时是有问题的
    }
    ...
    ```
    {: id="20210303213928-l5jn44o" updated="20210303213928"}
